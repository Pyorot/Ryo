...
module.exports = {initGym: initGym, reloadGyms: reloadGyms, reloadGym: reloadGym, loadAlerts: loadAlerts}
...
// Adds/replaces default loc, raid, obsolete, alerts to gym at loc (creates new gym if non-existent)
